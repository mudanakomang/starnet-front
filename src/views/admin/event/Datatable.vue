        ...
        <tr>
          <td class="d-none d-md-table-cell">
            <v-text-field
              ...
              dense
              maxlength="256"
              v-model="activeFilters.category_group"
            ></v-text-field>
          </td>
          <td class="d-none d-md-table-cell">
            <v-text-field
              ...
              dense
              maxlength="256"
              v-model="activeFilters.category_name"
            ></v-text-field>
          </td>
          <td class="d-none d-md-table-cell">
            <v-text-field
          ...
          <td class="d-none d-md-table-cell">
            <g-filter-date v-model="activeFilters.date"></g-filter-date>
          </td>
          <td class="d-none d-md-table-cell">
            <v-text-field
              outlined
...
export default {
  ...
  methods: {
    ...
    detailEvent: function(id) {
      this.$router.push({ name: "admin.event.show", params: { id } });
    }
  }
};
</script>
